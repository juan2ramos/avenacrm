...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__NumeralForm__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__DeleteAlert__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ToggleShowPassword__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__EnableField__ = __webpack_require__(11);





Object(__WEBPACK_IMPORTED_MODULE_3__EnableField__["a" /* EnableField */])('productsPoint');
...
var deleteElement = document.querySelector('#deleteElement');
if (deleteElement) {
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = NumeralForm;
...
var NumeralFormClass = function () {
    function NumeralFormClass(el) {
        _classCallCheck(this, NumeralFormClass);

        this.el = el;
        this.init();
    }

    _createClass(NumeralFormClass, [{
        key: 'init',
        value: function init() {
            if (this.el instanceof NodeList) return this.changeManyElements();
            this.changeElement(this.el);
        }
    }, {
        key: 'changeManyElements',
        value: function changeManyElements() {
        ...
        key: 'changeElement',
        value: function changeElement(el) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_sweetalert__ = __webpack_require__(6);
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = ToggleShowPassword;
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var ToggleShowPasswordClass = function () {
    function ToggleShowPasswordClass(settings) {
    ...
    return ToggleShowPasswordClass;
}();

function ToggleShowPassword(settings) {
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = EnableField;
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var EnableFieldClass = function () {
    function EnableFieldClass(fields) {
        _classCallCheck(this, EnableFieldClass);

        this.fields = fields;
        this.init();
    }

    _createClass(EnableFieldClass, [{
        key: 'init',
        value: function init() {
        ...
        key: 'actionsClass',
        value: function actionsClass(array, callback, scope) {
