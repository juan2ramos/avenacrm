    ...
    <div class="m-t-20 m-b-40">
        ...
        <a href="{{route('zonas.create')}}">
            <h3 class="row align-center justify-end">
                ...
                <span class="p-l-4">Agregar nueva zona</span>
            </h3>
        </a>
    </div>
    <div class="table-container m-t-a-12">
        <table>
            ...
            @foreach($areas as $area)
                <tr>
                    <td width="40px">{{$area->id}}</td>
                    <td>{{$area->name}}</td>
                    <td>
                        <a class="row align-center justify-center" href="{{route('zonas.edit',$area->id)}}">
